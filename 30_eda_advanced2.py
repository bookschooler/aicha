...
vif_table.to_csv('30_eda_vif_table.csv', index=False, encoding='utf-8-sig')
...
plt.tight_layout()
plt.savefig('30_eda_vif.png', dpi=150)
plt.close()
print("\n→ 30_eda_vif.png 저장 완료")
...
# 저장
top50.to_csv('30_eda_blueocean_candidates.csv', index=True, index_label='순위', encoding='utf-8-sig')
print("\n→ 30_eda_blueocean_candidates.csv 저장 완료")
...
plt.tight_layout()
plt.savefig('30_eda_blueocean.png', dpi=150)
plt.close()
print("→ 30_eda_blueocean.png 저장 완료")
...
plt.tight_layout()
plt.savefig('30_eda_gu_sales.png', dpi=150)
plt.close()
print("\n→ 30_eda_gu_sales.png 저장 완료")
